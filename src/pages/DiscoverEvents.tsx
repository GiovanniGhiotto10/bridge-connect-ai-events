...
import { Search, MapPin, Calendar, Users, Clock, ChevronRight, Star, Filter, Brain, Briefcase, Palette, Heart } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-6 md:py-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            return <Link key={category.id} to={`/todos-eventos?categoria=${categoryParam}`}>
