...
const EventImageUpload = ({
  ...
  return <div onClick={onImageClick} className="aspect-square w-80 h-80 bg-black rounded-lg border-2 border-dashed border-gray-600 hover:border-blue-400 transition-colors cursor-pointer flex items-center justify-center group mx-[200px] my-[80px]">
