  ...
  return (
    <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'header-scrolled' : 'bg-transparent'}`}>
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        {/* Logo */}
        <Link 
          to={isLoggedIn ? "/eventos" : "/"} 
          onClick={isLoggedIn ? handleDescobrirClick : undefined}
          ...
          {isLoggedIn ? (
            <>
              ...
              <div className="hidden md:flex items-center space-x-2">
                ...
                {/* Notifications Icon */}
                <Button variant="ghost" size="icon" className="text-black hover:bg-primary/20 hover:text-black">
